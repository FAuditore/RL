...
class VDN:
    ...
    def update(self, transition_dict):
        ...
        with torch.no_grad():
            ...
            max_next_q_total = self.mixer(max_next_qs)
    ...
    def save(self, folder='models'):
        torch.save(self.q_net.state_dict(), folder + "/vdn_q_net")

    def load(self, folder='models'):
        self.q_net.load_state_dict(torch.load(folder + '/vdn_q_net', map_location='cpu'))
...
agent = VDN(env, n_agents, observation_dim, state_dim, action_dim,
            hidden_dim, lr, target_update,
